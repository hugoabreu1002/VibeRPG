...
export const RANKS: RankData[] = [
  { rank: "F", minLevel: 1, label: "Novice (Rank F)", color: "#94A3B8", glow: "transparent" },
  { rank: "E", minLevel: 5, label: "Apprentice (Rank E)", color: "#10B981", glow: "rgba(16, 185, 129, 0.2)" },
  { rank: "D", minLevel: 10, label: "Soldier (Rank D)", color: "#3B82F6", glow: "rgba(59, 130, 246, 0.3)" },
  { rank: "C", minLevel: 20, label: "Veteran (Rank C)", color: "#8B5CF6", glow: "rgba(139, 92, 246, 0.4)" },
  { rank: "B", minLevel: 30, label: "Knight (Rank B)", color: "#EC4899", glow: "rgba(236, 72, 153, 0.5)" },
  { rank: "A", minLevel: 45, label: "Hero (Rank A)", color: "#F59E0B", glow: "rgba(245, 158, 11, 0.6)" },
  { rank: "S", minLevel: 60, label: "Legend (Rank S)", color: "#EF4444", glow: "rgba(239, 68, 68, 0.8)" },
];
